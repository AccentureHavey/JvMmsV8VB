...
Public Class AccountController
    ...
    Public Function Register(ByVal model As RegisterModel) As ActionResult
        If ModelState.IsValid Then
            ' 尝试注册用户
            Try
                WebSecurity.CreateUserAndAccount(model.UserName, model.Password, New With {.RealName = model.RealName, .State = EnumTypes.AccountState.Normal})
                WebSecurity.Login(model.UserName, model.Password)
                Return RedirectToAction("Index", "Home")
                Dim db As New JvDBContext
                LogHelper.Log(db, User.Identity.Name, EnumTypes.LogLevelType.Info, EnumTypes.LogEvenType.Register, "")
